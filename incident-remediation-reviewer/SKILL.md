...
When writing review prose, apply `../shared/alex-voice-core.md` if available. Keep the tone neutral, direct, and factual. Do not make counsel-facing text casual.
