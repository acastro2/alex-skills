...
- Apply the Attain testing baseline: load the `attain-standards` skill (test behavior not implementation, integration tests for API boundaries, descriptive scenario names).
