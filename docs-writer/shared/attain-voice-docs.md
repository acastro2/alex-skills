# The Attain House Voice — Technical Documentation

> Extends `attain-voice-core.md`. Read that first.
...
In blog form the house voice tells a story to teach. In docs it **gets you unstuck as fast as possible.** The warmth serves trust-building (so you follow the doc at 3 AM during an incident), not entertainment.
