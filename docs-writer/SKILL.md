---
name: docs-writer
description: Write or refactor technical documentation that is skimmable, decision-oriented, and implementation-grounded — in the Attain house voice (conversational, opinionated). Use for feature/system docs, API/tooling guides, onboarding, runbooks, and operational processes when you need clear value framing, progressive examples, diagrams, and prose that sounds like a smart colleague explaining things over coffee. Prefer existing repo doc templates/style guides when present.
license: MIT
...
> **Voice foundation:** Read `shared/attain-voice-core.md` for universal voice principles (voice first, plain words, direct over hedged, truth over completeness, opinionated).
...
> - `shared/attain-voice-core.md` — Personality, characteristics, signature phrases, never-use list, "Is it on-voice?" test
> - `shared/attain-voice-docs.md` — Docs-specific tone calibration and formatting rules
...
- [ ] Passes voice checks from `shared/attain-voice-core.md` and `shared/attain-voice-docs.md`
