...
When the user is working in an Attain Finance context (read `~/.config/opencode/attain-finance/DESIGN.md` for the full system), apply these defaults instead of Lucid's:
