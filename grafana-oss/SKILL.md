...
> `eeou8qj3gbvgge`). When in doubt, clone a working dashboard's `templating.list` verbatim;
> see the `dashboarding` skill for the full canonical variable schema and triage runbook.
