...
**Voice check:** Apply the voice checklist and never-use list from `../alex-voice/SKILL.md`, plus the blog-specific self-review checklist from `../alex-voice/references/alex-blogger.md`.
