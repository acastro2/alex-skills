...
const initContainer = taskDefinition.addContainer('init', {
  image: ecs.ContainerImage.fromRegistry('public.ecr.aws/aws-observability/adot-autoinstrumentation-java@sha256:{{ADOT_INIT_IMAGE_DIGEST}}'), // Resolve an approved version at or above the ServiceEvents minimum, then pin its digest.
  essential: false,
