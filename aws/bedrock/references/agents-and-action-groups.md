...
Check the current [Agents classic maintenance announcement](https://docs.aws.amazon.com/bedrock/latest/userguide/agents-classic-maintenance-mode.html) for customer eligibility and dates before provisioning. Existing-agent diagnosis does not authorize migration. Use [AgentCore fit and discovery](agentcore-options.md) when the user actually needs a hosting choice or migration assessment; preserve behavior, permissions and rollback rather than promising automatic parity.
