# The Attain House Voice — Internal Comms
...
In blog form the house voice teaches and mentors at length. In comms it is **shorter, faster, action-oriented.** The warmth is still there, but it serves getting to the point quickly — not building a narrative.
