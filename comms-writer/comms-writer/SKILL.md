---
name: comms-writer
description: Generates ready-to-send emails and Microsoft Teams messages in Alex's voice. Use when you need to communicate clearly and effectively with team members, stakeholders, or leadership. It focuses on clarity, brevity, and a conversational yet professional tone.
---
...
This skill adheres strictly to "Alex's Voice" — conversational, direct, substantial, and warm.

> **Voice Reference:** Before drafting, read the shared voice files:
>
> - `shared/alex-voice-core.md` — Personality, principles, signature phrases, anti-patterns
> - `shared/alex-voice-comms.md` — Email/Teams calibration and structure
...
- [ ] Does it sound like a human (Alex)?
